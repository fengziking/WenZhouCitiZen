...
@implementation UIButton (ImgTitleLayout)


//定义关联的Key
static const char * titleRectKey = "zzh_titleRectKey";
- (CGRect)titleRect {
...
//定义关联的Key
static const char * imageRectKey = "zzh_imageRectKey";
- (CGRect)imageRect {
