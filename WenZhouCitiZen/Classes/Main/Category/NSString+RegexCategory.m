...
//    NSString *phsRegex =@"^0(10|2[0-57-9]|\\d{3})\\d{7,8}$";
    NSString *mobile =@"^1(3[0-9]|4[579]|5[0-35-9]|7[01345678]|8[0-9])\\d{8}$";
    BOOL ret = [self isValidateByRegex:mobileNoRegex];
    BOOL ret1 = [self isValidateByRegex:mobile];
    
    return (ret || ret1);
}
+ (BOOL)isMobileNanNingNumber:(NSString *)mobile {
    //手机号是13，14，15，17，18，开头
